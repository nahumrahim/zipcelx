...
describe('Zipcelx', () => {
  const rowsXML = `<row r="1"><c r="A1" t="inlineStr" s="1"><is><t>Test</t></is></c><c r="B1" s="1"><v>1000</v></c></row>`;
...
<cols><col min="1" max="1" width="25" style="0" customWidth="1"/><col min="2" max="2" width="25" style="0" customWidth="1"/></cols>
<sheetData>${rowsXML}</sheetData></worksheet>`
    ].join('\n');
    expect(generateXMLWorksheet(baseConfig, baseConfig.sheet.data)).toBe(expectedXML);
  });
});
